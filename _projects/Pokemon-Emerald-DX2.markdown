---
layout: project
title: Pokemon Emerald DX2
date: 2022-07-23
---

The aim of this hack is to update Pokemon Emerald with Gen 6 features so it acts as a sister version to ORAS. It uses the RHH master branch as a base and a complete list of features added can be found here.
...
* Custom tournaments can be made using eReader Cards
...
* Battle Frontier has been updated to include Pokemon, Moves and Items up to Gen 6

## Planned Features
* Incorporate Primal Kyogre/Groudon & Mega Rayquaza
* Update Trainer teams to ORAS (maybe, idk yet)
* Have Alolan Pokemon searchable in the Pokedex (semi-implemented)
* Increase the number of mass outbreaks and have more interesting Pokemon (started)
* There's a few missing follower sprites (Therian formes/Shaymin Sky/Keldeo Resolute/Genesect formes/Zen Darmanitan)
* Have different types of PWT based on eCards
* Add Gym Leader and Champion overworlds for PWT